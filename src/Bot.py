...
from commands.image_commands import rotate, ascify, crop, saturate, grayscale, flip
...
image_commands = [blur, pixelate, emojioverlay, deepfry, caption1, caption2, cropcircle, rotate, ascify, crop, saturate, grayscale, flip]
