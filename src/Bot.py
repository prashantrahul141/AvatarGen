...
from commands.image_commands import blur, pixelate, emojioverlay, deepfry, caption1, caption2, cropcircle, rotate, ascify, crop
...
image_commands = [blur, pixelate, emojioverlay, deepfry, caption1, caption2, cropcircle, rotate, ascify, crop]
